...
* [⚙ Settings](using-ignited/settings/README.md)
  ...
  * [🔩 Features](using-ignited/settings/features/README.md)
    ...
    * [Controllers and Skins](using-ignited/settings/features/controllers-and-skins.md)
    * [Games Collection](using-ignited/settings/features/games-collection.md)
    * [User Interface](using-ignited/settings/features/user-interface.md)
    * [Touch Feedback](using-ignited/settings/features/touch-feedback.md)
    * [Advanced](using-ignited/settings/features/advanced.md)
  * [📀 Cores](using-ignited/settings/cores/README.md)
    * [Nintendo 64](using-ignited/settings/cores/nintendo-64.md)
    * [Game Boy Color](using-ignited/settings/cores/game-boy-color.md)
